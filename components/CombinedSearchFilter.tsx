...
export const CombinedSearchFilter = () => {
    ...
    // Updated dummy data with categories as array to support multiple
    const places = [
        { name: "Beach Cafe", categories: ["Caffe", "SeaFoods", "Ice Cream"], mood: "Relaxed" },
        { name: "City Grill", categories: ["BBQ & Grills", "Fast Food", "Restaurants"], mood: "Family-Friendly" },
        { name: "Downtown Hotel", categories: ["Hotel", "Desserts spots", "Cultural Food"], mood: "Romantic" },
        { name: "Market Bites", categories: ["Bites", "Fruits", "Mama Ntilie"], mood: "Cultural" },
        { name: "Seafood Spot", categories: ["SeaFoods", "BBQ & Grills"], mood: "Adventure" },
        { name: "Quick Eats", categories: ["Fast Food", "Ice Cream", "Fruits"], mood: "Shopping" },
    ];
    ...
    return (
        <div className="space-y-6">
            {/* Category Filter Section (from Filter.jsx, adapted for multi-select) */}
                            ...
                            {categories.map((category) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className="flex flex-col items-center text-mtoko-light w-[70px] flex-shrink-0 cursor-pointer hover:scale-105 transition-transform duration-300 no-underline hover:text-mtoko-light relative"
                                    >
                                        <div className="w-[70px] h-[70px] rounded-full p-[3px] bg-mtoko-light flex items-center justify-center relative">
                                            ...
                                            {isSelected && (
                                                <Check
                                                    className="absolute top-0 right-0 w-5 h-5 text-green-500 bg-white rounded-full p-1"
                                                />
                                            )}
                                        </div>
